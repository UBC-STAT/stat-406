...
These contains a README that gives some basic information about the available 
...
various projects in RStudio and run `sort(unique(renv::dependencies()$Package))`. 
