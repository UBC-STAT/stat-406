...
3. $Y$ and $\widehat{f}$ are independent.
...
Often also called a "validation set". This is not the same as "new data".
...
`r con` Each held out set is small $(n=1)$. Therefore, the variance of the SE of each prediction is high.
