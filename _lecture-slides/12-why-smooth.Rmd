...
* It depends on the **choice** of $h = cn^{-1/5}$
...
$$\textrm{MSE}(\hat f) = \frac{C_1+C_2}{n^{4/(4+d)}} + \sigma^2 \hspace{2em} \textrm{MSE}(\hat \beta)  = b + \frac{Cd}{n} + \sigma^2 .$$

--

What if $d$ is big (and $n$ is really big)?

1. Then $(C_1 + C_2) / n^{4/(4+d)}$ is still big.
2. But $Cd / n$ is small.
