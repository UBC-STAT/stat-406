...
```{r gam-mod, echo=FALSE, fig.width=5,fig.height=4, fig.align='center'}
...
$\textrm{MSE}(\hat f)-\sigma^2 = \frac{Cd}{n^{4/5}}.$
...
```{r gam-mod2, echo=FALSE, fig.width=6,fig.height=6, fig.align='center'}
...
```{r partition-view, echo=FALSE, fig.width=12,fig.height=5,fig.align="center"}
