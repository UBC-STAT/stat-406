...
* Module ends with an individual exam
...
1. Worksheets / Readings checks 15%
1. Assignments 20%
1. Mini-quizzes 10%
1. (Group) Project 20%
1. Final Exam 35%
...
## Worksheets / Reading / Assignments / Mini-quizzes


.pull-left[
**Worksheets and reading checks**
...
Submit any time you like (you have access to all of it now)

https://ubc-stat.github.io/stat-406-worksheets/index.html


* Reading check: "complete the code" (1 point each)

* Worksheet: longer, some done IN CLASS (2 points each)
]
...
Assignments are like long worksheets
...
-   Canvas: Grades, quizzes, links to stuff (videos)

-   Course website: All the material (slides, worksheets) https://ubc-stat.github.io/stat-406

- There is an R package. I wrote it for you. It installs everything R related you need. 
