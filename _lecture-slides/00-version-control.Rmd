...
* TAs review your work and merge the PR (they may ask for changes)


**Project**
* Each team gets a repo.
* Make other branches as you wish to divide up work
* When ready to submit, make sure that `main` is up to date. We'll clone and make a PR with the comments.
...
[Website](https://learning.github.ubc.ca/STAT-406-101-2021W/wkshts-labs-dajmcdon)
