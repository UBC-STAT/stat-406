...
```{r pca-reduced, fig.align='center',fig.height=5,fig.width=10,echo=FALSE}
...
```{r spiral-reduced, fig.align='center',fig.height=4,fig.width=10, echo=FALSE}
...
1.  Specify a kernel function $k$,  many people use $k(x,x') = \exp\left( -\norm{x - x'}_2^2/\gamma\right)$
...
The scores are still $\mathbf{Z} = \U\D$
