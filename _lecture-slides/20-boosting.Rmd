...
If $L(y,\ f(x))= \exp(-y f(x))$ and $G$ is a classifier, then this is equivalent to AdaBoost. Proven 5 years later (Friedman, Hastie, and Tibshirani 2000).
...
losses %>% pivot_longer(-x) %>%
  ...
  ylab("Loss") + xlab(bquote(y~f(x)~(Margin)))
```
