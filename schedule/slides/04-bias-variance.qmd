...
`r fa("plus", fill = green)` Compare with other predictors: $R_n(f)$ vs $R_n(g)$

`r fa("bomb", fill = red)` _This is hard:_  Don't know the distribution of the data (if I knew the truth, this would be easy)
