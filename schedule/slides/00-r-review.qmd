...
1. Introduction
1. My office hours will be in ESB3174 after class **today only**
    - I'm trying to book this room for future OHs
1. Reminder: fill in Quiz 0 if you haven't already!
1. Your labs are due at 23:00 on the night of the lab
...
::: callout-important
If you copy something, write a function. Validate your arguments. Write tests to check if inputs result in predicted outputs.
:::
...
- R is *very permissive*, and this leads to frequent *silent errors*
    - nonstandard evaluation of function arguments
...
- Classes are informal
    - can do crazy things like `class(x) <- "a weird new class!"`
