...
[\text{Err}(P) = E[\ell(Y, \hat Y)] = E[(Y - f(X))^2]]{.secondary}
...
$$
\text{Regression function } \triangleq E[Y \mid X] = \argmin_{P \in \mathcal P} \text{Err}(P) = \argmin_{P \in \mathcal P} E[\ell(Y, \hat Y)]
$$
