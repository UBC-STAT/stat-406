...
`r con` Estimate has high variance (depends on 1 choice of split)
...
`r pro` Bias is low because we used almost all the data to fit the model: $E[\mbox{LOO-CV}] = R_{n-1}$ 
