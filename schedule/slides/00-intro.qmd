...
$$\text{effort} = \min\left\{60, \text{clickers} + \text{lab} + \text{hw}\right\}$$

### Get 60 of the 70 total points any way you want
...
I write detailed lecture notes for every class.
...
3. (If needed) watch Github and R tutorials
:::
:::
