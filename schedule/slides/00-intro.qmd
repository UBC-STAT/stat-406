...
- 1950s: "intelligent machines", Turing test, sci-fi
- 1960s: Early perceptrons, hype cycle
- 1970s: AI Winter
- Early 1980s: Rule-based systems
- Late 1980s: Another winter
:::
...
🧐 Aren't these the same goals as AI? 🧐
...
::: {.columns}
::: {.column width="60%"}
- 2010s (Hinton, Bengio, LeCun): neural network revolution
    - Stats: ideas as "unprincipled"
    - CS: see lots of empirical success
    - Stats: backfill theory to explain phenomena
- 2020s: generative AI
...
3. Take Quiz 00 on Canvas **by EOD tomorrow!!!**
4. Sign up for Slack (see Canvas)
5. View the Course GitHub (once you have access)
