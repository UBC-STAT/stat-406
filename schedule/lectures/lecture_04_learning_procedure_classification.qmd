---
title: "Lecture 4: The Learning Procedure for Classification, Logistic Regression"
author: "Geoff Pleiss"
date: last-modified
format: html
---
...
| 3    | Training       | Estimation              | $\hat{\beta}_\mathrm{OLS/MLE} = (\boldsymbol{X}^\top \boldsymbol{X})^{-1} \boldsymbol{X}^\top \boldsymbol{Y}$ |
