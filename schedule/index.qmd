...
| Sep 4  | Class Overview ([slides](slides/00-intro.qmd))<br />Probability and SVD Review ([notes](lectures/lecture_01_probability.qmd))  |                               |           |
...
| Date      | Topic                                        | Readings                      | Deadlines |
|:----------------|:---------------------------|:-------------------------|:---------------------------|
| Oct 9 | Model Selection for Linear Methods<br />([notes](lectures/lecture_09_information_criteria.qmd))  |<br />(ESL 7.6-7.7)                | HW 2 due |
|||| <small>*Lab 04 (Oct 10)*</small><br />  |
| Oct 14  | Kernel Machines<br />([notes](lectures/lecture_10_kernels.qmd)) | ISLR 3.5<br />(ESL 2.3.2, 5.4.1)  |   |
| Oct 16 | kNN, Curse of Dimensionality<br />([notes](lectures/lecture_11_curse_of_dimensionality.qmd))           | ISLR 3.5, 8.1<br />(ESL 2.3.2, 5.4.1, 9.2)  |            |
| Oct 21 | Review   |          |           |
...
| Date      | Topic                                        | Readings                      | Deadlines          |
|:----------------|:---------------------------|:-------------------------|:---------------------------|
| Oct 28 | Trees (catch up from last module)<br />([Notes](lectures/lecture_12_trees.qmd))    | ISLR 8.1, 4.2.0<br />(ESL 9.2)    |            |
| Oct 30  | Dimensionality Reduction, Intro to Unsupervised Learning<br />([Notes](lectures/lecture_13_pca.qmd))                | ISLR 12.2<br />(ESL 14.5.1, 14.5.4)     |           |
|||| <small>*Lab 05 (Oct 31)*</small><br /> |
| Nov 04  | Clustering <br />([Notes](lectures/lecture_14_clustering.qmd))                     | ISLR 12.4.1<br />(ESL 14.3) |           |
| Nov 06  | *catch up*  |               |  HW 3 due    |
|||| <small>*Lab 07 (Nov 7)*</small><br /><small>**NOTE: SKIP LAB 06** |
...
| Nov 13  | The Bootstrap<br />([Notes](lectures/lecture_15_bootstrap.qmd))     |  ISLR 5.2<br />(ESL 7.11, 8.2)        |    |
| Nov 18 | Bagging, Random Forests<br />([Notes](lectures/lecture_16_bagging_and_random_forests.qmd))  |  ISLR 8.2.0-8.2.2<br />(ESL 8.7, 15.1-15.3)    |           |
| Nov 20  | Boosting<br />([Notes](lectures/lecture_17_boosting.qmd))     |  ISLR 8.2.3<br />(ESL 10.1-10.5, 10.9) |        |
...
| Date      | Topic                                        | Readings                      | Deadlines          |
|:----------------|:---------------------------|:-------------------------|:---------------------------|
| Nov 25 | Introduction to Neural Networks<br />([Notes](lectures/lecture_18_neural_networks.qmd))   | ISLR 10.1-10.2<br />(ESL 11.1, 11.3) |                    |
| Nov 27 | Neural Network Optimization<br />([Notes](lectures/lecture_19_gradient_descent_backpropagation.qmd)) | ISLR 10.7-10.8<br />(ESL 11.4)    | HW 4 due |
|||| <small>*Lab 09 (Nov 28)*</small><br /> |
| Dec 2  | Generalization<br />([Notes](lectures/lecture_20_neural_network_generalization.qmd)) |                               |                  |
| Dec 4  | Review (on Zoom)                            |                               |                    |
