...
Commit. For a lab to get full credit, you must have done this at least twice.
...
question marks that is NOT checked. This is what we want.
...
highlight the file by clicking the file name, click the Gear Icon Dropdown, and 
then select "Revert". Now it's gone, and the pdf should disappear from your 
filesystem. 
...
in Data Science or Software Development or Machine Learning, you might. 
...
And click the Blue Pull button to sync your `main` with the one on Github.
