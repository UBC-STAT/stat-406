...
## Course Info
__Dates__:\
Term 2026 W1, 08 Sep - 07 Dec 2026

__Instructor__:\
Vivian Meng\
Email: vivian[dot]meng[at]stat[dot]ubc[dot]ca
<!-- Website: <https://geoffpleiss.com/>\
Email: <geoff.pleiss@stat.ubc.ca>\
Slack: [@geoff](https://stat-406-2025.slack.com/)-->

__Office hours__:\
See [Canvas](https://canvas.ubc.ca/courses/192680/) for times and locations.

__Course webpage__:\
WWW: <https://ubc-stat.github.io/stat-406/>\
<!--GitHub: <https://github.com/stat-406-2025/>\-->
Canvas: <https://canvas.ubc.ca/courses/192680/>

__Lectures/Labs__:\
See [Canvas](https://canvas.ubc.ca/courses/192680/) for times and locations.


__Optional Textbooks__:\
[\[ISLR\]](https://www.statlearning.com)
[\[ESL\]](https://web.stanford.edu/~hastie/ElemStatLearn/)

__Prerequisite__:\
STAT 306 or CPSC 340, see [UBC academic calendar](https://vancouver.calendar.ubc.ca/course-descriptions/subject/statv) for details.
...
I highly recommend going through the lecture notes before every class.
(Prof. Geoff Pleiss put a lot of effort into making them!)
...
If you find yourself wanting to dive deeper, or learn the material from another source, I highly recommend the following textbooks.

1. (\[ISLR\]) *An Introduction to Statistical Learning*, James, Witten, Hastie, Tibshirani, 2013, Springer, New York. Available **free** online: <https://www.statlearning.com>.

2. (\[ESL\]) *The Elements of Statistical Learning*, Hastie, Tibshirani, Friedman, 2009, Second Edition, Springer, New York. Also available **free** online: <https://web.stanford.edu/~hastie/ElemStatLearn/>.

This second book is a more advanced treatment of a superset of the topics we will cover.
I link to the sections of the textbook that will be covered by each lecture.
...
- **You'll put in the work to develop deep intuitions.**
  You'll get to ask questions. We'll work through derivations during lecture that you won't see on labs or assignments.
...
| Labs | 18 |
| Homeworks | 40 |
| **Total** | `min(58, Clickers + Labs + Homeworks)` |
...
Throughout lecture, I will ask short multiple choice and True/False questions, which you will answer using the [iClicker](https://lthub.ubc.ca/guides/iclicker-cloud-student-guide/) app.
For each question, correct answers are worth `1`, incorrect answers are worth `0.5`.
...
submitted on Canvas.<!-- via pull requests in your personal `labs-<username>` repo (see
...
periods, but you can do them on your own as well. These are worth 2 points each. Due date can be found on Canvas. *Late submissions are not accepted.* <!--They are due at 2300 on the day of your assigned lab section.-->
...
There will be 4 homework assignments. <!--These are submitted via pull request similar to the labs but to the `homework-<username>` repo.--> Each assignment is worth up to 10 points. They are due by 23:59 on the deadline. <!--You must make **at least 5 commits**. Failure to have at least 5 commits will result in a 25% deduction on HW1 and a 50% deduction thereafter. **No exceptions.**--> Late submissions are **not** accepted.
...
You can always, of course, ask the other students and the teaching team for help on Piazza. Students are encouraged to help each-other, and the teaching team will endorse good answers. The teaching team will also add to student answers if further elaboration is required. *Please be mindful that the teaching team is only expected to be on the job during Weekdays work-hours to answer student questions.* <!--And public Pizza
...
The total you can accumulate across these 3 components is 58 points.  But you can get there however you want. The total available is 68 points. The rest is up to you. But with choice, comes responsibility.
...
* If you have **prolonged** extenuating circumstances *supported by proper documentation*, then we may consider shifting weight of missed lab or homework to the final exam if advised by your faculty advising office or CFA. Please contact me directly in this case.

<!--I'm not going to police this stuff. You don't need to let me know if you miss an assignment.  There is no reason that every single person enrolled in this course shouldn't get > 60 in this class.-->

**Illustrative scenarios:**

* Doing 80% on 4 homeworks (32 points), getting 10 clicker points, and completing 9 labs with perfect scores gets you > 58 points.
* Doing 90% on 4 homeworks (36 points), getting 8 clicker points, and completing 8 labs with perfect scores gets you >58 points.
* Getting full homeworks (40 points) and full labs, with 0 clicker points gets you 58 points.

Choose your own adventure. Note that the biggest barrier to getting to 58 is skipping the homeworks.
...
We likely won't start grading the minute after submission deadline has past, so don't worry if you're a few minutes late.
On the other hand, don't even bother submitting if you've missed the deadline by more than a day.
This policy may seem harsh, but remember that there are many paths to a full 58 on the effort-based grade.
...
The midterm and final are hard. It is intended to separate those who really understand the material from those who don't. Last year, the median grade on both the final and midterm was around 65%.

You can still end up with a very good grade even if you don't do well on the exams. If you put in the work (do all the effort points) and the median grade on the midterm and final (65%), you'll get an 85. If you put in the work (do all the effort points) and skip the midterm and final, you get a 58 You do not have to pass the final to pass the course. You don't even have to take the final.
...
For the full statement, please see the [UBC Vancouver Academic Calendar](http://www.calendar.ubc.ca/vancouver/index.cfm?tree=3,286,0,0#15620)
