...
```{r modelfittingridge, exercise=TRUE, message=FALSE, warning=FALSE, setup="modelfittinreg-setup"}
X = model.matrix(linmod)[,-1]
y = linmod$y
...
```{r trace, message=FALSE, warning=FALSE,setup="modelfittinreg-setup"}
...
```{r modelfittinglasso, exercise=TRUE, message=FALSE, warning=FALSE,setup="modelfittinreg-setup"}
...
```{r modelfittingenet, exercise=TRUE, message=FALSE, warning=FALSE,setup="modelfittinreg-setup"}
