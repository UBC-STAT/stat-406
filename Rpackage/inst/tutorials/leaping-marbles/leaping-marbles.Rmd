...
```{r fullmodel, exercise=TRUE, eval=FALSE, include=FALSE}
...
```{r cvfull, exercise=TRUE, eval=FALSE, include=FALSE}
...
```{r forward-sel, exercise=TRUE, eval=FALSE, include=FALSE}
stepup = regsubsets(
  ____,
  data = marbles,
  method = ____,
...
```{r backward-sel, exercise=TRUE, eval=FALSE, include=FALSE}
stepdown = regsubsets(
  ____,
  data = marbles,
  method = ____,
...
```{r cv, exercise=TRUE, exercise.setup="cvprep", eval=FALSE, include=FALSE}
...
```{r allcvs, exercise=TRUE, exercise.setup="cvprep", eval=FALSE, include=FALSE}
loocv(full)
